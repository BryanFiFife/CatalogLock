...
const p=mergePolicy();
const good={specVersion:'0.91',host:{displayName:'X'},entries:[{identifier:'urn:air:example.com:agent:x',displayName:'X',type:'application/a2a-agent-card+json',url:'https://example.com/x'}]};
